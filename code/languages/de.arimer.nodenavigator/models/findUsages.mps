...
<model ref="r:aa490968-17b7-4356-a37a-fdae4de2bc0c(de.arimer.nodenavigator.findUsages)">
      ...
      <node concept="3clFbS" id="5JgqVywdBs7" role="2VODD2">
        <node concept="3SKdUt" id="6ruCGOEllcQ" role="3cqZAp">
          <node concept="3SKdUq" id="6ruCGOEllcS" role="3SKWNk">
            <property role="3SKdUp" value="FIX: Here we do not use the node parameter at all, not sure how we could propagate this" />
          </node>
        </node>
